...
VOLUME ["/opt/wine-light/drive_c/light-capricoin"]
...
# Paths
ENV WINEPREFIX /opt/wine-light
RUN export WINEPREFIX=/opt/wine-light

ENV ELECTRUM_PATH $WINE_PREFIX/drive_c/light-capricoin
...
# RUN (echo light;echo light)|vnc4passwd
# EXPOSE 5933
