...
#test -d python-trezor || git clone https://github.com/Capricoinofficial/python-trezor
...
# Build docker images
$DOCKERBIN images|awk '{print $1":"$2}'|grep "capricoin/light-capricoin-winbuild:${VERSION}" || buildImage winbuild
$DOCKERBIN images|awk '{print $1":"$2}'|grep "capricoin/light-capricoin-release:${VERSION}" || buildImage release
