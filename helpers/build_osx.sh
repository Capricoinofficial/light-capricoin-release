...
if [ "$(uname)" = "Darwin" ];
  ...
  mv dist/Light-Capricoin.app ../src/ 
  cd ..
  #make  -  makes the unneeded dmg
  test -d helpers/release-packages/OSX || mkdir -pv helpers/release-packages/OSX
  #mv Light-Capricoin-${VER}.dmg helpers/release-packages/OSX
  mv src/Light-Capricoin.app helpers/release-packages/OSX
  cp helpers/make_OSX-installer.sh helpers/release-packages/OSX
  pushd helpers/release-packages/OSX
  mkdir Light-Capricoin.app/Contents/Resources/lib/python2.7/site-packages
  pushd  Light-Capricoin.app/Contents/Resources/lib/python2.7/site-packages
