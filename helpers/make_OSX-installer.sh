...
cp -av ${BUILD_REPO}/icons/light-capricoin-logo.jpg Resources/en.lproj/background



#pkgbuild --analyze --root ${INSTALL_ROOT} 'Light-Capricoin.plist'
...
#echo "sed"
sed -e '$ i\
 \    <title>Light-Capricoin '${VERSION}'</title>' \
 -e '$ i\
