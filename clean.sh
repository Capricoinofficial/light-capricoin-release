...
all(){
 ...
 rm -rf source/Light Capricoin Wallet*
 rm -rf source/light-capricoin-setup.exe
 rm -rf ltc_scrypt*
 ...
 rm -rf helpers/.??*
 rm -rf helpers/repo
 rm -rf helpers/light-capricoin-release
 rm -rf src/Light Capricoin Wallet-*.dmg 
 rm -rf Makefile
...
case $CLEAN in 
    osx) echo "Cleaning for build_osx.sh"
         rm -rf src/Light Capricoin Wallet.app
